    ...
    return (
        <div className='contack-shadow px-4 py-3 mt-14 md:mt-0'>
            ...
            <form className='' onSubmit={handleSubmit(onSubmit)}>
                ...
                <input className='form-control block w-full md:px-3 px-1 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none mb-3' type="text" {...register("name", { required: true, maxLength: 20 })} />

                <label>Email<span className='text-red-800'>*</span></label>
                <input className='form-control block w-full md:px-3 px-1 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none mb-3' type="email"  {...register("email", { required: true, })} />
